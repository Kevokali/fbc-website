  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative bg-gold hover:bg-gold/90 text-deep-blue font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 group overflow-hidden">
