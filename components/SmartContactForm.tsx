  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-emerald/10">
      ...
      <div className="mb-8">
        ...
        <div className="mb-6">
          <p className="text-sm font-semibold text-deep-blue mb-4">Choose how you&apos;d like to connect with us:</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col items-center text-center">
                <svg 
                  className={`w-8 h-8 mb-3 transition-colors duration-300 ${
                    contactMethod === 'whatsapp' ? 'text-emerald' : 'text-emerald/70'
                  }`} 
                  fill="currentColor" 
                  viewBox="0 0 24 24"
                >
                ...
                <span className={`font-semibold text-base mb-1 ${
                  contactMethod === 'whatsapp' ? 'text-deep-blue' : 'text-deep-blue/90'
                }`}>
                  WhatsApp Chat
                </span>
                <p className="text-xs text-text-secondary leading-relaxed">Fastest response</p>
              </div>
            </button>
            ...
            >
              <div className="flex flex-col items-center text-center">
                <svg 
                  className={`w-8 h-8 mb-3 transition-colors duration-300 ${
                    contactMethod === 'email' ? 'text-emerald' : 'text-emerald/70'
                  }`} 
                  fill="none" 
                  viewBox="0 0 24 24" 
                  stroke="currentColor" 
                ...
                <span className={`font-semibold text-base mb-1 ${
                  contactMethod === 'email' ? 'text-deep-blue' : 'text-deep-blue/90'
                }`}>
                  Email Consultation
                </span>
                <p className="text-xs text-text-secondary leading-relaxed">Detailed inquiry</p>
              </div>
            </button>

            <a
              href="tel:+254754029431"
              className={`p-5 rounded-xl border-2 transition-all duration-300 block ${
                contactMethod === 'call'
                  ? 'border-emerald bg-emerald/10 shadow-lg'
                  : 'border-soft-grey bg-light-grey hover:border-emerald/50 hover:shadow-md'
              }`}
            ...
            >
              <div className="flex flex-col items-center text-center">
                <svg 
                  className={`w-8 h-8 mb-3 transition-colors duration-300 ${
                    contactMethod === 'call' ? 'text-emerald' : 'text-emerald/70'
                  }`} 
                  fill="none" 
                  viewBox="0 0 24 24" 
                  stroke="currentColor" 
                ...
                <span className={`font-semibold text-base mb-1 ${
                  contactMethod === 'call' ? 'text-deep-blue' : 'text-deep-blue/90'
                }`}>
                  Instant Consultation
                </span>
                <p className="text-xs text-text-secondary leading-relaxed">Talk to an expert now</p>
              </div>
            </a>
          </div>
        </div>
      ...
      {contactMethod === 'call' && (
        <div className="bg-gradient-to-br from-emerald/10 to-deep-blue/10 rounded-xl p-8 border-2 border-emerald/30 text-center">
          <div className="w-16 h-16 bg-emerald rounded-full flex items-center justify-center mx-auto mb-4">
            <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
          </div>
          <h4 className="text-2xl font-bold text-deep-blue mb-3">Get Instant Expert Advice</h4>
          <p className="text-text-secondary mb-6">
            Speak directly with our financial experts. No forms, no waiting—just instant professional guidance.
          </p>
          <a
            href="tel:+254754029431"
            className="inline-flex items-center gap-3 px-8 py-4 bg-emerald hover:bg-emerald-dark text-white font-bold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105"
          >
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
            <span>Call: +254 754 029 431</span>
          </a>
